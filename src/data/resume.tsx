...
export const DATA = {
  ...
  contact: {
    email: "joaquinlucascortez@gmail.com",
    tel: "+5492616929207",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/JoaquinCortezHub",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/joaqu%C3%ADn-cortez/",
        icon: Icons.linkedin,
  ...
  work: [
    {
      ...
      description:
        "Developed and maintained user-facing websites using Next.js, Typescript and React for personal projects such as a personal programming blog or a portfolio website.",
    },
    {
      ...
      description:
        "Designed and presented multiple projects for the courses and internships I was part of, appling knowledge of accesibility standards and providing creative solutions to complex problems while adhering to brand guidelines across multimple platforms.",
    },
  ],
  education: [
    {
      school: "Universidad del Aconcagua, Argentina",
      href: "https://www.uda.edu.ar",
      degree: "Degree in Informatics and Software Development",
      logoUrl: "/UDA.jpeg",
      start: "2024",
      end: "Today",
    },
    {
      school: "KreativStorm",
      href: "https://www.kreativstorm.de/",
      degree: "UX/UI certification",
      logoUrl: "/kreativstorm_logo.jpeg",
      start: "Jun, 2023",
      end: "Aug, 2023",
    },
    {
      school: "CoderHouse UX/UI Program",
  ...
  projects: [
    ...
    },
    {
      ...
      active: true,
      description:
        "I wanted a way to keep track of my carreer path journey, after trying different ways of sharing my story and my knowledge, I decided to develop my own personal blog, dedicated to compiling updates about my life as a software development and also to keep track of my ongoing projets.",
      technologies: [
        "Next.js",
        "Typescript",
        "React",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/JoaquinCortezHub/dev-journal-frontend",
          icon: <Icons.github className="size-3" />,
        }
      ],
      image: "/blog-site.png",
    ...
    },
    {
      ...
      href: "https://qr-codex-gen.netlify.app",
      dates: "June 2024",
      active: false,
      description:
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/JoaquinCortezHub/QR-GEN",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/qr-code.png",
